...
아래에서 하나 고르시거나, 지금 해내고 싶은 일을 그대로 말씀해 주세요.`,
	...
	"ru": `Привет! Добро пожаловать в %[1]s. Multica — рабочее пространство, где люди и ИИ-агенты вместе выполняют задачи.

Я %[2]s. Помогу определить, что нужно сделать, подобрать подходящего агента и организовать работу.

Начнём с цели: расскажите о ней, а я создам задачу и запущу подходящего агента. Вы сможете следить за ходом работы.

Выберите один из вариантов ниже или просто напишите, что хотите сделать сейчас.`,
}
