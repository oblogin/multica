...
type AgentTaskResponse struct {
	...
	InteractionContext          string               `json:"interaction_context,omitempty"` // quoted answer context assigned atomically to this claim
	interactionContextSupported bool
...
func (h *Handler) ListAgentTasks(w http.ResponseWriter, r *http.Request) {
	...
	h.hydrateTaskInteractionMetadata(r.Context(), agent.WorkspaceID, tasks, resp)
